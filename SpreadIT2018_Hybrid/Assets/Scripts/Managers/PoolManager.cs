...
namespace Assets.Scripts
{
    public class PoolManager : Singleton<PoolManager>
    {
        ...
        public class ObjectPool
        {
            ...
            public List<bool> UsedObjects { get { return m_used; } }
            ...
            public GameObject SpawnObject(Vector3 i_position, Quaternion i_rotation)
            {
            ...
            public void ReturnToPool(GameObject i_obj)
            {
