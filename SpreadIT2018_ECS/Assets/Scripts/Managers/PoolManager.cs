...
namespace Assets.Scripts
{
    public class PoolManager : Singleton<PoolManager>
    {
        ...
        public class ObjectPool
        {
            ...
            public MonoBehaviour m_template;
            public int m_cnt = 0;
            internal List<MonoBehaviour> m_pool = new List<MonoBehaviour>();
            internal List<bool> m_used = new List<bool>();
            ...
            public MonoBehaviour SpawnObject(Vector3 i_position, Quaternion i_rotation)
            {
